...
#define S_FUNCTION_NAME rtdacpci_abs_resistors
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *(y+0) = (double)(_inpd( (unsigned short)(BaseAddress + 0x90) ) & 0x01 );
    *(y+1) = (double)((_inpd( (unsigned short)(BaseAddress + 0x90) ) >> 1) & 0x01 );
    *(y+2) = (double)(_inpd( (unsigned short)(BaseAddress + 0x94) ) );
    *(y+3) = (double)(_inpd( (unsigned short)(BaseAddress + 0x98) ) );
    *(y+4) = (double)(_inpd( (unsigned short)(BaseAddress + 0x9C) ) );
    *(y+5) = (double)(_inpd( (unsigned short)(BaseAddress + 0xA0) ) );
}
