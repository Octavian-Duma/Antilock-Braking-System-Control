...
#define S_FUNCTION_NAME rtdacpci_abs_frequency
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *(y+0) = (double)(_inpd( (unsigned short)(BaseAddress + 0x38) ) );
    *(y+1) = (double)(_inpd( (unsigned short)(BaseAddress + 0xA4) ) );
    if ( (int)(_inpd( (unsigned short)(BaseAddress + 0xAC) ) & 0x2) != 0)
      *(y+2) = 1;
    else
      *(y+2) = 0;
}
